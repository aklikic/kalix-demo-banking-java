...
//    }
//    @PostMapping("/manage/{accountId}/topup")
//    public Effect<BalanceResponse> topUpBalance(@PathVariable String accountId, @RequestBody TopUpBalanceRequest request){
//        return effects().forward(componentClient.forEventSourcedEntity(accountId).call(AccountEntity::topUpBalance).params(request));
//    }
}
